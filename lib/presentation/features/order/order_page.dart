...
class _OrderContainerState extends State<OrderContainer> {
              ...
              children: [
                Expanded(
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          itemList(snapshot.data?[index], context)),
                ),
              ],
            );
          },
  ...
  Widget itemList(Order? orderModel, BuildContext context) {
    ...
    return ListTile(
      ...
      subtitle: Text(
        "Tổng Tiền : ${NumberFormat("#,###", "en_US").format(orderModel.price ??= 0)} đ",
      ...
      trailing: ElevatedButton(
          ...
          setState(() {
            WidgetsBinding.instance.addPostFrameCallback((_) {
              Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (_) => _buildOrderDetail(orderModel, context)));
              print('test chi tiết');
            });
        ...
        child: const Text("Chi Tiết", style: TextStyle(fontSize: 14)),
      ),
    );
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(top: 5),
                            child: Text(
                              (orderModel?.products?[0].address).toString(),
                              maxLines: 3,
                              overflow: TextOverflow.ellipsis,
                          ...
                          Container(
                            ...
                            child: Text(
                              "Giá : ${NumberFormat("#,###", "en_US").format(orderModel?.price)} đ",
                          ...
                          Container(
                            ...
                            child: Text(
                              ("Số Lượng: ${orderModel?.products?[0].quantity}")
                                  .toString(),
                              maxLines: 1,
                              overflow: TextOverflow.ellipsis,
                              style: GoogleFonts.amita(
